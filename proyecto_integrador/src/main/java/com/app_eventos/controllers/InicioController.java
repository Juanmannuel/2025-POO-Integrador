...
import com.app_eventos.utils.DatosDePrueba;
...
public class InicioController {
    ...
    // --- NUEVAS VARIABLES FXML PARA LOS FILTROS ---
    ...
    public void initialize() {
        // Obtenemos todos los eventos del simulador
        this.todosLosEventos = DatosDePrueba.getEventosDePrueba();
        this.eventosFiltrados = new ArrayList<>(this.todosLosEventos); // Al inicio, mostramos todo
    ...
    // --- Métodos para los botones de navegación del calendario ---
